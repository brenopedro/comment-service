package com.algaworks.comment_service.api.config.web;

import com.algaworks.comment_service.api.client.ModerationClientBadGatewayException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handle(ModerationClientBadGatewayException e) {
        ...
        problemDetail.setDetail(e.getMessage());
        problemDetail.setType(URI.create("/errors/bad-gateway-timeout"));
